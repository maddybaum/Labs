...
function nameCheck(name){
  ...
  if (name === "STEVEN"){
    ...
    return `Cool name ${personName}`
  }
}
let nameGreeting = nameCheck('George')
...
let sharknadoTest = bestMovie('sharknado');
console.log(sharknadoTest);
...
let check = theEliminator(contestants, loser)
console.log(check)
...
console.log(convertToUpperCase(sampleString));
//CODE HERE
...
function emailCheck(email){
  let checkEmail = email.toString().trim();
...
console.log(emailCheck('madeline.baum94@gmail.com'));
console.log(emailCheck('fredyahoo.com'))
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
function numberOfChocolateFrogs(gold){
  let numberOfFrogs = Math.floor(gold/3);
  return `You are able to purchase ${numberOfFrogs}`
}
let totalFrogs = numberOfChocolateFrogs(13);
...
let sampleArray = [0,1,2,3,4,5,6,10, ];
//CODE HERE
function checkIfAscending(arr){
  for (let i = 0; i < arr.length; i++){
    if (arr[i] > arr[i + 1]){
      return false
    }
...
let arrayIsAscending = checkIfAscending(sampleArray);
...
let globalScope = ['duck', 'bathroom', 'pond']
